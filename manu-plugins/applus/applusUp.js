...
var entryCompressImageResolve = (entry,resolve,fail)=>{
	compressImage(entry.toLocalURL(),entry.name,'compress',resolve,fail);
};
...
var applus = {
	...
	image2Base64:(imageUrl,resolve,fail)=>{
		readFileAndResolve(imageUrl,'DATA_URL',resolve,null,fail);
	}
};
